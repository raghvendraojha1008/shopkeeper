  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        // ── Theme-aware utilities (th- prefix = "theme") ──────────────────
        // These map Tailwind color classes to CSS variables, so any component
        // using them automatically works in both light and dark mode.
        // Usage: text-th-primary, bg-th-card, border-th-border, etc.
        'th-primary':   'var(--text-primary)',
        'th-secondary': 'var(--text-secondary)',
        'th-muted':     'var(--text-muted)',
        'th-card':      'var(--card-bg)',
        'th-surface':   'var(--surface-1)',
        'th-surface-2': 'var(--surface-2)',
        'th-modal':     'var(--modal-bg)',
        'th-sheet':     'var(--modal-sheet-bg)',
        'th-glass':     'var(--glass-bg)',
        'th-input':     'var(--input-bg)',
        'th-border':    'var(--glass-border)',
        'th-separator': 'var(--separator)',
        'th-app-bg':    'var(--app-bg)',
      },
      borderRadius: {
        '4xl': '2rem',
        '5xl': '2.5rem',
