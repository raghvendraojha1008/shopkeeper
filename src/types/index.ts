...
export interface LastOrderAutofillFields {
  rate: boolean;
  gst_percent: boolean;
  unit: boolean;
  quantity: boolean;
...
export interface AutomationSettings {
  ...
  auto_distribute_payments: boolean;
  ...
  default_unit: string;
  default_filter_period: 'current_month' | 'current_year' | 'current_business_year' | 'all';
  last_order_autofill: boolean;
  last_order_autofill_fields: LastOrderAutofillFields;
}
