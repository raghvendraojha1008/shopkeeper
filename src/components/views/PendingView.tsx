...
const PendingView: React.FC<PendingViewProps> = ({ user, onBack, appSettings = {}, initialFilter }) => {
  ...
  return (
    <div className="h-full overflow-y-auto relative" style={{background: 'var(--app-bg)'}}>
      ...
      <div className="sticky top-0 z-30 px-4 pb-3" style={{paddingTop: '16px', background:"rgba(var(--app-bg-rgb),0.93)", backdropFilter:"blur(20px)", boxShadow:"0 1px 0 rgba(255,255,255,0.06)"}}>
      ...
      <div className="p-4 space-y-4">
        ...
        <div className={`p-4 rounded-[2.5rem] flex justify-between items-center relative overflow-hidden ${activeTab === 'receivable' ? 'border border-emerald-500/20' : 'border border-rose-500/20'}`}>
            ...
            <div className="text-right relative z-10 whitespace-nowrap flex-shrink-0">
                ...
                <div className="text-xs font-black text-[rgba(240,244,255,0.95)] bg-[rgba(255,255,255,0.10)] px-3 py-1 rounded-full shadow-sm inline-block border border-white/20">₹{waiverAmount}</div>
            </div>
                ...
                <div className="flex-1 min-w-0 pr-3">
                  <div className="flex items-center gap-1.5 mb-2 flex-wrap">
                    ...
                    {order.hasAutoPayment && !bulkMode && (
                      <span className="text-[7px] font-black px-1.5 py-0.5 rounded-full flex items-center gap-0.5 whitespace-nowrap" style={{ background: 'rgba(99,102,241,0.15)', color: '#818cf8', border: '1px solid rgba(99,102,241,0.2)' }}>
                        <Zap size={7} /> Auto Adj.
                      </span>
                    )}
                ...
                <div className="px-6 pb-6 pt-3 border-t border-dashed border-white/08 animate-in fade-in slide-in-from-top-6 duration-500">
                  ...
                  <div className="space-y-3 mb-8">
                    ...
                    {order.hasAutoPayment && order.autoPayments?.length > 0 && (
                      <div className="mt-4 p-3 rounded-2xl border border-dashed" style={{ borderColor: 'rgba(99,102,241,0.3)', background: 'rgba(99,102,241,0.05)' }}>
                        <div className="flex items-center gap-1.5 mb-3">
                          <Zap size={11} style={{ color: '#818cf8' }} />
                          <span className="text-[9px] font-black uppercase tracking-wider" style={{ color: '#818cf8' }}>
                        ...
                        <div className="space-y-2">
                          {order.autoPayments.map((ap: any, idx: number) => (
                            <div key={idx} className="flex items-center justify-between text-[10px]">
                              <div className="flex items-center gap-2">
                                <span className="font-mono px-1.5 py-0.5 rounded-md text-[8px]" style={{ background: 'rgba(99,102,241,0.15)', color: '#a5b4fc' }}>
                                  #{String(ap.txId).slice(-6).toUpperCase()}
                                </span>
                                <span style={{ color: 'rgba(165,180,252,0.65)' }}>{ap.date}</span>
                              </div>
                              <span className="font-black" style={{ color: '#a5b4fc' }}>₹{Math.round(ap.amount).toLocaleString('en-IN')}</span>
                            </div>
                          ))}
                        </div>
                      </div>
      ...
      {showWaiverBox && (
        <div className="fixed inset-0 bg-slate-950/80 backdrop-blur-md z-[100] flex items-end sm:items-center justify-center p-4 transition-all">
            <div
              className="waiver-box-root w-full max-w-sm rounded-2xl shadow-[0_24px_48px_-12px_rgba(0,0,0,0.6)] p-5 animate-in slide-in-from-bottom-12 duration-300"
            ...
            >
                <div className="flex justify-between items-center mb-4">
                    <div className="flex items-center gap-3">
                        ...
                        <h2 className="text-base font-black text-[rgba(240,244,255,0.95)] tracking-tight">Set Waiver</h2>
                    </div>
                ...
                <p className="text-[10px] font-bold text-[rgba(148,163,184,0.55)] mb-3 leading-relaxed uppercase tracking-wider">
                ...
                <div className="relative mb-5 group">
                    ...
                    <input
                        ...
                        className="w-full py-3 pl-9 pr-3 rounded-xl text-xl font-black outline-none border-2 border-transparent focus:border-blue-500 transition-all text-[rgba(240,244,255,0.95)]"
      ...
      {showBulkThreshold && (
        <div className="fixed inset-0 bg-slate-950/80 backdrop-blur-md z-[100] flex items-end sm:items-center justify-center p-4 transition-all">
            <div
              className="w-full max-w-sm rounded-2xl shadow-[0_24px_48px_-12px_rgba(0,0,0,0.6)] p-5 animate-in slide-in-from-bottom-12 duration-300"
              style={{ background: '#0f1221', border: '1px solid rgba(255,255,255,0.1)' }}
            >
                <div className="flex justify-between items-center mb-4">
                    <div className="flex items-center gap-3">
                        ...
                        <h2 className="text-base font-black text-[rgba(240,244,255,0.95)] tracking-tight">Select by Amount</h2>
                    </div>
                ...
                <div className="relative mb-5 group">
                    ...
                    <input
                        ...
                        className="w-full py-3 pl-9 pr-3 rounded-xl text-xl font-black outline-none border-2 border-transparent focus:border-green-500 transition-all text-[rgba(240,244,255,0.95)]"
                        style={{ background: 'rgba(255,255,255,0.05)', borderColor: 'rgba(255,255,255,0.08)' }}
                        placeholder="1000"
                    />
                </div>
