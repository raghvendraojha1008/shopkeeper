...
const ReportsView: React.FC<ReportsViewProps> = ({ user, onBack }) => {
  ...
  return (
    <div className="flex flex-col h-full" style={{background: 'var(--app-bg)'}}>
      ...
      {/* STICKY HEADER */}
      <div className="sticky top-0 z-20 px-3 pt-3 pb-2 md:px-6" style={{background:"rgba(var(--app-bg-rgb),0.95)", backdropFilter:"blur(20px)", boxShadow:"0 1px 0 rgba(255,255,255,0.05)"}}>
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="flex-1">
                        <p className="text-sm font-bold text-white">Download CSV</p>
                        <p className="text-[10px] text-slate-400">Filtered list • Excel-friendly</p>
                      </div>
                    </button>
                    ...
                    >
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-[10px] text-slate-400">Full report • All sections</p>
                      </div>
                    </button>
                  </div>
                )}
      ...
      {/* SCROLLABLE BODY */}
      <div className="flex-1 overflow-y-auto px-3 md:px-6 pb-20">

        {/* SUMMARY CARD */}
        <div className="p-4 rounded-2xl shadow-lg mt-3 mb-3 flex justify-between items-center relative overflow-hidden" style={{background:"linear-gradient(135deg,rgba(79,70,229,0.85),rgba(99,102,241,0.7))"}}>
