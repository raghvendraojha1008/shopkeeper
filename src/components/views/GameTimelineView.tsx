              ...
              {items.length > 0 && (
                <div className="mt-4 mb-2">
                  ...
                  <div className="mt-3 p-3 rounded-2xl space-y-2"
                    ...
                    {r.discount_amount > 0 && (
                      <div className="flex justify-between">
                        <span className="text-xs font-semibold" style={{ color: 'rgba(148,163,184,0.55)' }}>Discount</span>
          ...
          <div className="flex items-center gap-1.5">
            {filterDate && (
              <button
                ...
                className="flex items-center gap-1 px-2.5 py-1.5 rounded-xl text-[10px] font-black active:scale-90 transition-all"
            ...
            <div className="relative">
              <button
                ...
                style={{
                  background: filterDate ? 'rgba(96,165,250,0.2)' : 'rgba(255,255,255,0.07)',
                  border: filterDate ? '1px solid rgba(96,165,250,0.35)' : '1px solid rgba(255,255,255,0.1)',
                }}
              >
                <Calendar size={16} style={{ color: filterDate ? '#60a5fa' : 'rgba(148,163,184,0.6)' }} />
              </button>
