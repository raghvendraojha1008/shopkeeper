          ...
          <div className="rounded-[20px] overflow-hidden"
            ...
            <div className="p-4 space-y-2.5">
              <p className="text-[9px] font-black uppercase tracking-[0.15em] mb-1"
                style={{ color: 'rgba(148,163,184,0.4)' }}>Payment Status</p>

              <div className="flex justify-between text-[11px]">
                <span style={{ color: 'rgba(148,163,184,0.55)' }}>Grand Total</span>
                <span className="font-bold tabular-nums" style={{ color: 'rgba(226,232,240,0.75)' }}>{fmtINR(total)}</span>
              </div>
              <div className="flex justify-between text-[11px]">
                <span style={{ color: 'rgba(148,163,184,0.55)' }}>Paid</span>
                <span className="font-black tabular-nums" style={{ color: '#34d399' }}>{fmtINR(paidAmount)}</span>
              </div>
              {pendingAmount > 0 && (
                <div className="flex justify-between text-[11px]">
                  <span className="flex items-center gap-1" style={{ color: 'rgba(148,163,184,0.55)' }}>
                    <span style={{ color: '#fbbf24', fontSize: 9 }}>⏳</span> Pending
                  </span>
                  <span className="font-black tabular-nums" style={{ color: '#fbbf24' }}>{fmtINR(pendingAmount)}</span>
                </div>
              )}
            ...
            <div className="px-4 pb-4 space-y-1.5"
              ...
              <p className="text-[8px] font-black uppercase tracking-wider mt-3 mb-2"
                style={{ color: 'rgba(148,163,184,0.35)' }}>Linked Payments</p>
              {linkedTxns.map((t: any, i: number) => (
                <div key={i}
                  ...
                  <div className="flex items-center gap-2">
                    <Wallet size={11} style={{ color: '#34d399' }} />
                    <span className="text-[10px] font-bold" style={{ color: 'rgba(148,163,184,0.75)' }}>
                      {t.payment_mode || 'Cash'}
                    </span>
                    {t.date && (
                      <span className="text-[9px]" style={{ color: 'rgba(148,163,184,0.35)' }}>· {t.date}</span>
                    )}
                  </div>
