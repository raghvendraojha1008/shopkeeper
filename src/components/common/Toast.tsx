...
const Toast: React.FC<ToastProps> = ({ id, message, type, onClose, actionLabel, onAction }) => {
  ...
  const CONFIGS = {
    success: { grad: 'linear-gradient(135deg,rgba(5,150,105,0.92),rgba(6,95,70,0.88))', bdr: 'var(--col-emerald-60)', ic: "var(--col-emerald-50)", txt: "var(--col-emerald-50)", ibg:  'var(--rgba-white-18)', btn: 'linear-gradient(135deg,#10b981,#059669)', glow: 'var(--col-emerald-40)' },
    error:   { grad: 'linear-gradient(135deg,rgba(220,38,38,0.92),rgba(153,27,27,0.88))',   bdr: 'var(--col-danger-60)',   ic: "var(--col-red-50)", txt: "var(--col-red-50)", ibg:  'var(--rgba-white-18)', btn: 'linear-gradient(135deg,#ef4444,#dc2626)', glow: 'var(--col-danger-40)'   },
    info:    { grad: 'linear-gradient(135deg,rgba(79,70,229,0.92),rgba(55,48,163,0.88))',    bdr: 'var(--col-accent-60)',  ic: "var(--col-indigo-50)", txt: "var(--col-indigo-50)", ibg:  'var(--rgba-white-18)', btn: 'linear-gradient(135deg,#6366f1,#4f46e5)', glow: 'var(--col-accent-40)'  },
  };
  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: `0 8px 32px ${cfg.glow}, 0 2px 6px var(--rgba-black-25), inset 0 1px 0 var(--rgba-white-15)`,
