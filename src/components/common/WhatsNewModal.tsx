      ...
      >
        ...
        <div className="flex items-center gap-3 px-5 pt-5 pb-4 shrink-0">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-[9px] font-black uppercase tracking-[0.2em]" style={{ color: 'rgba(167,139,250,0.7)' }}>
              Version {APP_VERSION}
            </p>
            <h2 className="text-base font-black text-white" style={{ letterSpacing: '-0.02em' }}>
              What&apos;s New
            </h2>
          </div>
          <button
          ...
          >
            <X size={15} style={{ color: 'rgba(148,163,184,0.6)' }} />
          </button>
        </div>
          ...
          {WHATS_NEW.map((item, i) => {
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-[12px] font-black text-white leading-tight">{item.title}</p>
                  <p className="text-[10px] mt-0.5 leading-relaxed" style={{ color: 'rgba(148,163,184,0.6)' }}>
                    {item.desc}
                  </p>
                </div>
              </div>
        ...
        <div className="px-4 pb-5 pt-3 shrink-0">
          <button
            onClick={handleDismiss}
            className="w-full py-3.5 rounded-[18px] font-black text-[14px] text-white flex items-center justify-center gap-2 active:scale-[0.98] transition-all"
            style={{
