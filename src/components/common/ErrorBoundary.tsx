    ...
    return (
      ...
      >
        <div className="max-w-xs w-full">
          ...
          {/* Body */}
          <p className="text-sm mb-3 leading-relaxed" style={{ color: 'rgba(148,163,184,0.7)' }}>
            {isChunk
          ...
          {!isChunk && this.state.error?.message && (
            <p className="text-[10px] mb-6 font-mono px-3 py-2 rounded-xl break-all text-left leading-snug"
