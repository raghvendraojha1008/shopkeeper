 ...
 *  9. Android GPU fix: completely disables backdrop-filter when class
 *     'android-no-backdrop' is present on <html>
 */
...
const SeoHead = () => {
  useEffect(() => {
    ...
    if (document.getElementById('seo-global-styles')) return;
    ...
    style.innerHTML = `
      ...
      .shadow-primary\\/20 { box-shadow: 0 4px 14px var(--col-indigo-25) !important; }
      ...
      .bg-white\\/10 { background-color: var(--rgba-white-10); }
      .bg-white\\/15 { background-color: var(--rgba-white-15); }
      .bg-black\\/50 { background-color: var(--rgba-black-50); }
      .bg-black\\/80 { background-color: var(--rgba-black-85); }

      /* Focus ring utilities */
      .focus\\:ring-0:focus { box-shadow: none; outline: none; }
      .focus\\:ring-2:focus { box-shadow: 0 0 0 2px var(--col-indigo-50); }
      .focus\\:ring-blue-500:focus { box-shadow: 0 0 0 2px var(--col-info-50); }
      .focus\\:ring-primary\\/30:focus { box-shadow: 0 0 0 3px var(--col-indigo-35); }
      ...
      .divide-white\\/10 > * + * { border-color: var(--rgba-white-10); }
      ...
      * { -ms-overflow-style: none; scrollbar-width: none; }
      ...
      .border-white\\/08 { border-color: var(--rgba-white-08) !important; }
      .border-white\\/06 { border-color: var(--rgba-white-06) !important; }
      .border-white\\/10 { border-color: var(--rgba-white-10) !important; }
      .border-white\\/12 { border-color: var(--rgba-white-12) !important; }
      ...
      @media (max-width: 900px) {
        ...
        [style*="boxShadow"],
        [style*="box-shadow"] {
          box-shadow: 0 1px 6px var(--rgba-black-25) !important;
        }
      }
      ...
      /* ═══════════════════════════════════════════════════════════
         ANDROID GPU FIX — Disable backdrop-filter entirely on Mali devices
         ═══════════════════════════════════════════════════════════ */
      .android-no-backdrop [style*="backdrop-filter"],
      .android-no-backdrop [style*="backdropFilter"],
      .android-no-backdrop [class*="backdrop-blur"],
      .android-no-backdrop [style*="backdrop"] {
        -webkit-backdrop-filter: none !important;
        backdrop-filter: none !important;
      }

      /* Force bottom nav to use a solid background on Android */
      .android-no-backdrop .app-bottom-nav > div > div {
        background: var(--rgba-black-85) !important;
        backdrop-filter: none !important;
        -webkit-backdrop-filter: none !important;
      }

      /* Also kill any filter: blur on Android that might cause texture issues */
      .android-no-backdrop [style*="filter: blur"],
      .android-no-backdrop [style*="filter:blur"] {
        filter: none !important;
      }
    `;
