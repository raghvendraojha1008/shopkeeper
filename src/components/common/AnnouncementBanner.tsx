...
const TYPE_CONFIG = {
  info: {
    bg:      'var(--col-accent-15)',
    border:  'var(--col-accent-35)',
    iconBg:  'var(--col-accent-15)',
    color:   "var(--col-violet)",
    Icon:    Info,
  },
  warning: {
    bg:      'var(--col-warning-15)',
    border:  'var(--col-warning-35)',
    iconBg:  'var(--col-warning-15)',
    color:   "var(--col-warning)",
    Icon:    AlertTriangle,
  },
  success: {
    bg:      'var(--col-success-08)',
    border:  'var(--col-success-25)',
    iconBg:  'var(--col-success-12)',
    color:   "var(--col-success)",
    Icon:    CheckCircle,
  },
  maintenance: {
    bg:      'var(--col-danger-08)',
    border:  'var(--col-danger-25)',
    iconBg:  'var(--col-danger-12)',
        ...
        return (
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <p className="text-app-md font-black leading-tight" style={{ color: cfg.color }}>
                {a.title}
              </p>
