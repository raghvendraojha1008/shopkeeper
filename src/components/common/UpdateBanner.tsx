  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        <p className="text-[10px]" style={{ color: 'rgba(196,181,253,0.7)' }}>
          v{APP_VERSION} → v{LATEST_VERSION}
        </p>
      </div>
      <button
        onClick={handleAction}
        className="px-3 py-2 rounded-lg text-[11px] font-bold text-white flex items-center gap-1.5 active:scale-95 transition-transform"
