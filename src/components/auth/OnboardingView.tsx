            ...
            <div className="space-y-3 flex-1 overflow-y-auto pb-1">
              ...
              <div className="rounded-[18px] p-3.5"
                ...
                <div className="flex items-center justify-between mb-2">
                  <label className="text-[10px] font-black uppercase tracking-wider" style={{ color: 'rgba(148,163,184,0.55)' }}>
                    GSTIN — Auto-fill from GST number
                  </label>
                  <span className="text-[9px]" style={{ color: 'rgba(148,163,184,0.35)' }}>Optional</span>
                </div>
                <div className="relative">
                  <div className="absolute left-3.5 top-1/2 -translate-y-1/2">
                    <Hash size={13} style={{ color: 'rgba(148,163,184,0.4)' }} />
                  </div>
                  <input
                    type="text"
                    value={firm.gstin}
                  ...
                  {firm.gstin.length === 15 && (
                    <button
                      ...
                      className="absolute right-2 top-1/2 -translate-y-1/2 flex items-center gap-1.5 px-3 py-1.5 rounded-[9px] font-black text-[10px] transition-all active:scale-95 disabled:opacity-60"
                      style={{
                        background: gstFetchResult
                          ? 'rgba(16,185,129,0.18)'
                          : 'linear-gradient(135deg,rgba(99,102,241,0.95),rgba(139,92,246,0.95))',
                        color: gstFetchResult ? '#34d399' : '#fff',
                        border: gstFetchResult ? '1px solid rgba(16,185,129,0.3)' : 'none',
                      }}>
                      {gstFetching
                ...
                {firm.gstin.length === 15 && !gstFetchError && !gstFetchResult && (
                  <p className="text-[9px] mt-1 font-bold" style={{ color: 'rgba(52,211,153,0.7)' }}>
                ...
                {gstFetchError && (
                  <div className="mt-2 flex items-start gap-2 p-2.5 rounded-[10px]"
                    ...
                    <AlertCircle size={11} className="flex-shrink-0 mt-0.5" style={{ color: '#f87171' }} />
                    <p className="text-[9px] font-bold" style={{ color: 'rgba(248,113,113,0.9)' }}>{gstFetchError}</p>
                  </div>
                )}
                  ...
                  <div className="mt-2 rounded-[12px] overflow-hidden"
                    ...
                    <div className="px-3 pt-2.5 pb-1 flex items-center justify-between">
                      <div className="flex items-center gap-1.5">
                        ...
                        <span className="text-[8px] font-black uppercase tracking-wider" style={{ color: '#34d399' }}>
                        ...
                        <span className="text-[8px] font-black px-1.5 py-0.5 rounded-full"
                          style={{
                            background: gstFetchResult.status.toLowerCase() === 'active'
                              ? 'rgba(16,185,129,0.18)' : 'rgba(251,191,36,0.18)',
                            color: gstFetchResult.status.toLowerCase() === 'active' ? '#34d399' : '#fbbf24',
                          }}>
                          {gstFetchResult.status}
                        </span>
                      )}
                      ...
                      {gstFetchResult.filledFields.length > 0 ? (
                        <div className="flex flex-wrap gap-1 mt-1">
                          {gstFetchResult.filledFields.map(f => (
                            <span key={f} className="text-[8px] font-black px-1.5 py-0.5 rounded-md"
        ...
        {step === 'firstentry' && (
          <div className="flex flex-col flex-1">
            ...
            <div className="space-y-3 flex-1">
              {[
                { step: '1', icon: Package,      color: '#34d399', bg: 'rgba(16,185,129,0.1)',  title: 'Add an Item',      desc: 'Go to Inventory → tap + to add your first product with price & stock' },
                { step: '2', icon: FileText,     color: '#60a5fa', bg: 'rgba(59,130,246,0.1)',  title: 'Create a Bill',    desc: 'Open Quick Bill → pick items → tap Save Bill to generate an invoice' },
                { step: '3', icon: BookOpen,     color: '#a78bfa', bg: 'rgba(139,92,246,0.1)',  title: 'View Your Ledger', desc: 'See all sales and purchases with running balance in the Ledger tab' },
                { step: '4', icon: Users,        color: '#fbbf24', bg: 'rgba(245,158,11,0.1)',  title: 'Track Parties',    desc: 'Add customers & suppliers to monitor dues and payment history' },
              ].map((item, i) => (
