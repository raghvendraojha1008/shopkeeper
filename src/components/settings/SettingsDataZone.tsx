    ...
    return (
        <div className="space-y-6 animate-in slide-in-from-right duration-300">
             <SettingsSection title="Data Management" icon={Database}>
                ...
                <div className="bg-[var(--col-accent-08)] p-4 rounded-xl border border-[var(--col-accent-25)] mb-4 flex gap-3">
                    <Cloud className="text-indigo-400 shrink-0" size={20}/>
                    <div className="flex-1">
                        <h4 className="font-bold text-sm text-col-indigo-light">Offline Sync</h4>
                        ...
                        {syncProgress && (
                            <div className="mt-2 w-full bg-[var(--col-accent-25)] h-1.5 rounded-full overflow-hidden">
                                <div
                ...
                <div className="bg-[var(--col-info-07)] p-4 rounded-xl border border-[var(--col-info-18)] mb-4 flex gap-3">
                    <Database className="text-blue-400 shrink-0" size={20}/>
                    <div>
                        <h4 className="font-bold text-sm text-col-info-light">Backup & Restore</h4>
                ...
                <div className="bg-[var(--col-emerald-07)] p-4 rounded-xl border border-[var(--col-emerald-18)] mb-4 flex gap-3">
                    <FileSpreadsheet className="text-green-600 shrink-0" size={20}/>
                    <div>
                        <h4 className="font-bold text-sm text-col-success-light">Export to Excel/CSV</h4>
                ...
                <div className="mt-4 pt-4 border-t border-white/10">
                    <div className="bg-[rgba(244,63,94,0.07)] p-4 rounded-xl border border-[rgba(244,63,94,0.18)] mb-4 flex gap-3">
                        <Trash2 className="text-col-danger shrink-0" size={20}/>
                        <div>
                            <h4 className="font-bold text-sm text-col-danger-light">Recycle Bin</h4>
                    ...
                    <button 
                        ...
                        className="w-full py-3 bg-[rgba(244,63,94,0.10)] text-col-danger-light rounded-xl font-bold text-sm flex items-center justify-center gap-2 active:scale-95 transition-all border border-[rgba(244,63,94,0.2)]"
                    >
            ...
            <SettingsSection title="Device Backup (Auto)" icon={Smartphone}>
                <div className="bg-[var(--col-accent-07)] p-4 rounded-xl border border-[var(--col-accent-18)] mb-4 flex gap-3">
                    <Clock className="text-indigo-400 shrink-0" size={20}/>
                    <div>
                        <h4 className="font-bold text-sm text-col-indigo-light">Auto Daily Backup</h4>
                ...
                {showLocalBackups && (
                    <div className="space-y-2 max-h-[250px] overflow-y-auto">
                        {localBackups.length === 0 ? (
                            ...
                            <div key={i} className="flex justify-between items-center p-3 rounded-xl border border-white/10 bg-[var(--rgba-white-04)]">
                                <div>
                                    <div className="font-bold text-xs text-[var(--text-secondary)]">{b.date}</div>
                                    <div className="text-app-sm text-[var(--text-muted)]">{b.name}</div>
                                </div>
                                <button
                                    onClick={() => handleRestoreLocal(b.name)}
                                    disabled={restoreLocalLoading === b.name}
                                    className="px-3 py-1.5 bg-[var(--col-accent-15)] text-indigo-300 rounded-lg text-app-sm font-bold active:scale-95 disabled:opacity-50"
                                >
            ...
            <SettingsSection title="Google Drive Backup" icon={Cloud}>
                <div className="rounded-[16px] p-4 mb-4 flex gap-3"
                    ...
                    <div className="shrink-0 mt-0.5">
                        <svg width="20" height="20" viewBox="0 0 87.3 78" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="m73.55 76.8c1.35-.8 2.5-1.9 3.3-3.3l1.6-2.75 7.65-13.25c.8-1.4 1.2-2.95 1.2-4.5h-27.502l5.852 11.5z" fill="var(--col-google-red)"/>
                            <path d="m43.65 25 13.75-23.8c-1.35-.8-2.9-1.2-4.5-1.2h-18.5c-1.6 0-3.15.45-4.5 1.2z" fill="#00832d"/>
                            <path d="m59.8 53h-32.3l-13.75 23.8c1.35.8 2.9 1.2 4.5 1.2h50.8c1.6 0 3.15-.45 4.5-1.2z" fill="#2684fc"/>
                            <path d="m73.4 26.5-12.7-22c-.8-1.4-1.95-2.5-3.3-3.3l-13.75 23.8 16.15 27h27.45c0-1.55-.4-3.1-1.2-4.5z" fill="var(--col-warning-light)"/>
                        </svg>
                    </div>
                    <div>
                        <h4 className="font-bold text-sm" style={{ color: "var(--col-info-light)" }}>Backup to Google Drive</h4>
                ...
                {driveLastFile && (
                    <div className="flex items-center gap-2 px-3 py-2 rounded-xl mb-3"
                        ...
                        <span className="text-app-sm font-bold" style={{ color: 'rgba(147,197,253,0.7)' }}>
                            Last: {driveLastFile}
                        </span>
                    </div>
                )}
                ...
                />
                <p className="text-app-sm mt-2 text-center" style={{ color: 'var(--text-muted)' }}>
            ...
            <SettingsSection title="Activity Log" icon={History}>
                <div className="bg-[var(--rgba-white-04)] p-4 rounded-xl border border-white/10 mb-4">
            ...
            <SettingsSection title="Help & Feedback" icon={MessageSquare}>
                ...
                <button
                    ...
                    style={{ background: 'linear-gradient(135deg, var(--col-accent-18), var(--col-violet-18))', color: "var(--col-violet-light)" }}
                >
                ...
                <div className="flex items-center justify-between px-4 py-3 rounded-xl"
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-app-md font-bold" style={{ color: 'var(--text-muted)' }}>App version</span>
                    </div>
                    <span className="text-app-md font-mono font-black" style={{ color: 'rgba(196,181,253,0.85)' }}>
                        v{APP_VERSION}
                    </span>
                </div>
            </SettingsSection>

            <div className="bg-[var(--col-danger-07)] p-5 rounded-2xl border border-[var(--col-danger-25)] mt-8">
                ...
                <div className="space-y-3">
                    <button
                        ...
                        style={{ borderColor: 'rgba(251,146,60,0.3)', color: "var(--col-orange-400)", background: 'rgba(251,146,60,0.07)' }}
                    >
            ...
            {showAuditLog && (
                <div className="fixed inset-0 bg-black/75 backdrop-blur-sm z-[100] flex items-end sm:items-center justify-center p-4">
                    <div className="audit-log-modal-root w-full max-w-lg max-h-[80vh] rounded-2xl shadow-2xl overflow-hidden animate-in slide-in-from-bottom-8 duration-300" style={{ border: '1px solid var(--glass-border)' }}>
                        <div className="p-4 border-b flex justify-between items-center sticky top-0 z-10" style={{ background: 'var(--modal-bg)', borderColor: 'var(--glass-border)' }}>
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-app-sm text-slate-400 uppercase font-bold">Last 30 days · {auditLogs.length} entries</p>
                                </div>
                            </div>
                            <button 
                                onClick={() => setShowAuditLog(false)}
                                className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-app-md font-black active:scale-95 transition-all"
                        ...
                        <div className="overflow-y-auto max-h-[60vh] p-4 space-y-3" style={{ background: 'var(--modal-sheet-bg)' }}>
                            {auditLogs.length === 0 ? (
                                <div className="text-center py-10">
                                    <History size={40} className="mx-auto mb-3 text-slate-300"/>
                                    <p className="text-sm font-bold text-[var(--text-muted)]">No activity in the last 30 days</p>
                                </div>
                            ) : (
                                auditLogs.map((log, i) => {
                                    const changes: {field: string; before: any; after: any}[] = log.changes || [];
                                    return (
                                        <div key={log.id || i} className="p-3 rounded-xl bg-[var(--rgba-white-04)]" style={{ border: '1px solid var(--glass-border)' }}>
                                            <div className="flex justify-between items-start mb-2">
                                                <span className={`text-app-xs font-black uppercase px-2 py-0.5 rounded ${
                                                    log.action === 'create' ? 'bg-[var(--col-emerald-15)] text-emerald-400' :
                                                    log.action === 'update' ? 'bg-[var(--col-info-15)] text-blue-400' :
                                                    log.action === 'delete' ? 'bg-[var(--col-danger-15)] text-red-400' :
                                                    'bg-[var(--col-violet-25)] text-violet-300'
                                                }`}>
                                                    {log.action}
                                                </span>
                                                <span className="text-app-sm text-[var(--text-muted)]">
                                                    {new Date(log.timestamp).toLocaleString('en-IN')}
                                                </span>
                                            </div>
                                            <p className="text-sm font-bold text-[var(--text-primary)]">{log.summary}</p>
                                            <p className="text-app-sm text-slate-400 mt-1">{log.collection?.replace(/_/g, ' ')}</p>
                                            {log.user_email && (
                                                <p className="text-app-sm text-slate-500 mt-0.5">By: {log.user_email}</p>
                                            )}
                                            {changes.length > 0 && (
                                                <div className="mt-2 space-y-1.5 pt-2" style={{ borderTop: '1px solid var(--glass-border)' }}>
                                                    {changes.map((ch, ci) => (
                                                        <div key={ci} className="text-app-sm rounded-lg overflow-hidden">
            ...
            {showResetOtp && (
                <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-[110] flex items-center justify-center p-4">
                    <div className="w-full max-w-sm rounded-2xl border border-red-500/30 shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200" style={{ background: 'var(--modal-bg)' }}>
                        {/* Header */}
                        <div className="p-5" style={{ borderBottom: '1px solid var(--glass-border)' }}>
                            <div className="flex items-center gap-3 mb-1">
                                <div className="w-10 h-10 rounded-xl flex items-center justify-center" style={{ background: 'var(--col-danger-15)', border: '1px solid var(--col-danger-35)' }}>
                                    <ShieldAlert size={20} style={{ color: "var(--col-danger)" }} />
                                </div>
                                <div>
                                    <h3 className="font-black text-[var(--text-primary)]">Verify Identity</h3>
                                    <p className="text-app-sm font-bold text-slate-400 uppercase tracking-wider">Factory Reset Authorization</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="p-5 space-y-4">
                            {/* Email notice */}
                            <div className="flex items-start gap-3 p-3 rounded-xl" style={{ background: 'var(--col-info-08)', border: '1px solid var(--col-info-25)' }}>
                                <Mail size={16} className="text-blue-400 mt-0.5 shrink-0" />
                                <div>
                                    <p className="text-app-md font-bold text-blue-300">Verification code sent to:</p>
                                    <p className="text-app-md text-blue-400 font-mono mt-0.5">{user?.email || 'your email'}</p>
                                </div>
                            </div>

                            {/* Show code (displayed in-app since no email service is connected) */}
                            <div className="p-4 rounded-xl text-center" style={{ background: 'var(--col-danger-07)', border: '1px dashed var(--col-danger-35)' }}>
                                <p className="text-app-xs font-black uppercase tracking-widest text-red-400 mb-2">Your Verification Code</p>
                                <div className="flex items-center justify-center gap-2">
                                    {generatedOtp.split('').map((d, i) => (
                                        <span key={i} className="w-9 h-11 flex items-center justify-center rounded-lg font-black text-xl" style={{ background: 'var(--col-danger-12)', border: '1px solid var(--col-danger-25)', color: "var(--col-danger-light)" }}>
                                            {d}
                                        </span>
                                    ))}
                                </div>
                                <p className="text-app-2xs text-slate-500 mt-2">Tip: Connect an email service to send this automatically</p>
                            </div>

                            {/* Timer */}
                            <div className="flex items-center justify-center gap-2">
                                <Clock size={13} style={{ color: otpSecondsLeft <= 15 ? "var(--col-danger)" : "var(--col-slate)" }} />
                                <span className={`text-app-md font-black tabular-nums ${otpSecondsLeft <= 15 ? 'text-red-400 animate-pulse' : 'text-slate-400'}`}>
                        ...
                        <div className="px-5 pb-5 flex gap-3">
                            ...
                            <button
                                ...
                                style={{ background: 'var(--col-danger-25)', border: '1px solid var(--col-danger-40)', color: "var(--col-danger-light)" }}
                            >
...
const LastBackupCard: React.FC<{ userId: string }> = ({ userId }) => {
    ...
    return (
        <div
            ...
            style={{
                background: never ? 'var(--col-warning-07)' : 'var(--col-emerald-07)',
                border: never ? '1px solid var(--col-warning-22)' : '1px solid var(--col-emerald-22)',
            }}
        >
            <ShieldCheck
                className="shrink-0"
                size={20}
                style={{ color: never ? "var(--col-warning)" : "var(--col-success)" }}
            />
            <div className="flex-1 min-w-0">
                <h4 className="font-bold text-sm" style={{ color: never ? "var(--col-warning-light)" : "var(--col-success-light)" }}>
                ...
                <p className="text-xs mt-1" style={{ color: never ? 'rgba(252,211,77,0.78)' : 'rgba(110,231,183,0.85)' }}>
                    {never
                        ...
                        : <>{label}{sourceLabel ? <span className="ml-1.5 text-app-sm opacity-70">· {sourceLabel}</span> : null}</>}
                </p>
            </div>
        </div>
    );
