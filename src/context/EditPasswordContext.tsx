  ...
  return (
    <EditPasswordContext.Provider value={{ requireEditPassword, setEditPasswordSettings }}>
          ...
          >
            ...
            <div
              ...
              style={{
                ...
                boxShadow: '0 12px 32px var(--col-accent-40)',
              }}
            >
              <Lock size={28} className="text-white" />
            </div>

            <h2 className="text-xl font-black mb-1" style={{ letterSpacing: '-0.03em', color: 'var(--text-primary)' }}>
              Data Password
            </h2>
            <p className="text-xs mb-8" style={{ color:  'var(--rgba-white-35)' }}>
              ...
              {[0, 1, 2, 3].map(i => (
                <div
                  ...
                  style={{
                    ...
                    boxShadow: i < pin.length && !error ? '0 0 10px var(--col-accent-70)' : 'none',
                  }}
                />
              ))}
            </div>
            ...
            <div className="grid grid-cols-3 gap-3 w-full mb-3">
              {[1, 2, 3, 4, 5, 6, 7, 8, 9].map(num => (
                <button
                  ...
                  className="aspect-square rounded-[18px] font-black text-xl flex items-center justify-center active:scale-90 transition-all"
                  style={{
              ...
              >
                <Delete size={22} style={{ color:  'var(--rgba-white-35)' }} />
              </button>
            </div>
            ...
            <div className="h-6 flex items-center justify-center">
              {error && (
                <p
                  className="text-app-md font-black uppercase tracking-[0.15em] animate-pulse"
            ...
            {wrongAttempts >= 2 && user?.email && (
              <button
                ...
                className="mt-1 text-app-md font-bold active:scale-95 transition-all"
            ...
            {showPinSetup && (
              <div className="w-full mt-2 animate-in slide-in-from-bottom-4 duration-200">
                ...
                <p className="text-app-sm text-center mb-4" style={{ color: 'var(--text-muted)' }}>
                  Choose a 4-digit PIN for editing &amp; deleting entries
                </p>

                {/* New PIN field */}
                <label className="block text-app-sm font-bold uppercase tracking-wider mb-1"
                ...
                <input
                  ...
                  style={{ background: 'var(--rgba-white-07)', border: '1px solid rgba(255,255,255,0.12)', color: 'white', letterSpacing: '0.8rem' }}
                />
                ...
                {pinSetupError && (
                  <p className="text-app-md font-black text-center animate-pulse mb-2" style={{ color: "var(--col-danger)" }}>
                    {pinSetupError}
                  </p>
                )}
                ...
                <button
                  ...
                  style={{ background: 'linear-gradient(135deg,#6366f1,#8b5cf6)', boxShadow: '0 8px 24px var(--col-accent-35)' }}
                >
                  Save PIN
                </button>
              </div>
      ...
      {deleteConfirm.visible && (
        <div
          className="edit-password-root fixed inset-0 z-[9990] flex items-center justify-center p-6"
          style={{ background: 'var(--rgba-black-75)', backdropFilter: 'blur(10px)' }}
        >
          <div
            className="w-full max-w-[300px] rounded-[24px] p-6 flex flex-col items-center"
            style={{
              background: 'var(--modal-bg)',
              border: '1px solid var(--col-danger-30)',
              boxShadow: '0 24px 64px var(--rgba-black-70)',
            }}
          >
            <div
            ...
            >
              <Trash2 size={24} style={{ color: "var(--col-danger)" }} />
            </div>

            <h2 className="text-lg font-black mb-2" style={{ letterSpacing: '-0.02em', color: 'var(--text-primary)' }}>
              Delete Record?
            </h2>
            <p className="text-xs text-center mb-6" style={{ color:   'var(--rgba-white-40)' }}>
            ...
            <div className="flex gap-3 w-full">
              <button
                ...
                style={{ background: 'var(--rgba-white-08)', color: 'var(--text-muted)', border: '1px solid rgba(255,255,255,0.1)' }}
              >
                Cancel
              </button>
              <button
                ...
                style={{ background: 'linear-gradient(135deg,#dc2626,#ef4444)', boxShadow: '0 4px 16px var(--col-danger-40)' }}
              >
                Delete
              </button>
            </div>
